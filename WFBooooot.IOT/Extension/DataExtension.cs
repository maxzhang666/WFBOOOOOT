...
namespace WFBooooot.IOT.Extension
{
    public static class DataExtension
    {
        ...
        public static string Format(this VoidTrader voidTrader)
        {
            ...
            {
                var time = (DateTime.Now - voidTrader.expiry).Humanize(int.MaxValue, CultureInfo.GetCultureInfo("zh-CN"), TimeUnit.Day, TimeUnit.Second, " ");
        ...
        /// <returns></returns>
        public static string Format(this Reward reward)
        {
